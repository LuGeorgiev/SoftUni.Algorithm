...
namespace IterativePermutationsWithoutRep
{
    class Program
    {
        ...
        {
            for (int i = 0; i < permuttaion.Count-1; i++)
            {
                Console.Write(elements[permuttaion[i]]+" ");
            }
            Console.Write(elements[permuttaion[permuttaion.Count-1]]);
            Console.WriteLine();
        }
    }
}
